...
export function PendingRequestSkeleton() {
  return (
    <SkeletonTheme baseColor="#FFFCF7" highlightColor="#F7F1E3">
      <div
        className="pending-request__page"
      ...
      >
        ...
        <div className="pending-request__container">
          {/* Student Actions */}
          <div
            className="pending-request__student-action"
            style={{
              display: "flex",
          ...
          >
            ...
            <div
              className="pending-request__search-block"
              style={{
                position: "relative",
                display: "grid",
                alignItems: "center",
            ...
            >
              ...
              <div
                className="search-block--dropdown-menu"
          ...
          {/* Request List */}
          <div
            className="pending-request__student-list"
          ...
          {/* See More */}
          <div
            className="pending-request__see-more"
            style={{
              marginTop: "20px",
              textAlign: "center",
            }}
