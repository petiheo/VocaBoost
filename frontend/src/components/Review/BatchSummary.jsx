      ...
      <div className="summary-container">
        ...
        <div className="summary-stats">
          ...
          <div className="stat-card">
            <div className="stat-number">{correctAnswers}/{wordsInBatch}</div>
            <div className="stat-label">Correct Answers</div>
          </div>

          <div className="stat-card">
            <div className="stat-number">{overallProgress.overallAccuracy}%</div>
            <div className="stat-label">Overall Accuracy</div>
          </div>

          <div className="stat-card">
            <div className="stat-number">{overallProgress.completedWords}/{overallProgress.totalWords}</div>
        ...
        <div className="progress-bar-container">
          <div className="progress-label">
            Overall Progress: {overallProgress.completedWords} of {overallProgress.totalWords} words
          </div>
          ...
          <div className="progress-percentage">
            {Math.round((overallProgress.completedWords / overallProgress.totalWords) * 100)}%
          </div>
        </div>
