    ...
    <div className="class-header">
        ...
        {showDropdown &&
          (user?.role === "teacher" ? (
            <div className="dropdown-menu">
              <button onClick={handleRemoveClassroom} className="dropdown-item">
                Remove
              </button>
            </div>
          ) : (
            <div className="dropdown-menu">
              <button onClick={handleLeaveClassroom} className="dropdown-item">
                Leave
              </button>
            </div>
          ))}
      ...
      <div className="header-left">
        ...
        <div className="class-tags">
          ...
          <span className="tag">
            <img
              src={ClassroomTitlePattern}
              alt="classroom-memebers"
              width="13px"
            />{" "}
            {selectedClassroom.learner_count}
          </span>
          {user?.role === "teacher" ? (
