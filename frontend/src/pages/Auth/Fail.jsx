...
export default function Fail() {
    return (
        <div className="fail-container"
            ...
            <div className="the-request">The request could not be sent. Please try again later</div>
            <Link to="/homepage" className="go-to-home-page"> Go to home page </Link>
            <img src={FailPattern} alt="fail-pattern" className="sign-up-element" width="30%"  />
        </div>
    )
}