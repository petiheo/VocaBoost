...
const SkeletonDemo = () => {
  ...
  const skeletonComponents = {
    ...
    TableRowSkeleton: () => (
      <table>
        <tbody>
          <TableRowSkeleton count={3} columns={4} />
        </tbody>
      </table>
    ),
    ...
    // Page Skeletons
    CarouselSectionSkeleton: () => (
      <CarouselSectionSkeleton title="TEST CAROUSEL" showTabs={true} />
    ),
          ...
          <div className="manage-classroom-learner__content">
            <div style={{ padding: "20px" }}>
              ...
              >
                ...
                <ul>
                  <li>
                    Press <kbd>Ctrl + Shift + S</kbd> to toggle skeleton on any
                    page
                  </li>
                  <li>
                    Press <kbd>Ctrl + Shift + L</kbd> for long skeleton test
                    (10s)
                  </li>
